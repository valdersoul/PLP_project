...
public class P1 {
    ...
    public static void BuildTree(String a, int b, Stack<NSTree> c){
        NSTree new_node = new NSTree(0,a);
        while (b!=0){
   ...
   public static void E(ArrayList<Token> a, Stack<NSTree> b){
    ...
    public static void Bp(ArrayList<Token> a, Stack<NSTree> b){
        A(a,b);
        switch(next(a)){
            case LexToInt.gr : read(a); A(a,b); BuildTree("gr",2,b); break;
            case LexToInt.ge : read(a); A(a,b); BuildTree("ge",2,b); break;
            case LexToInt.ls : read(a); A(a,b); BuildTree("ls",2,b); break;
            case LexToInt.le : read(a); A(a,b); BuildTree("le",2,b); break;
            case LexToInt.eq : read(a); A(a,b); BuildTree("eq",2,b); break;
            case LexToInt.ne : read(a); A(a,b); BuildTree("ne",2,b); break;
            default: break;
        }
    }
    ...
    public static void A(ArrayList<Token> a, Stack<NSTree> b){
        ...
        while(next(a) == LexToInt.plus || next(a) == LexToInt.minus){
            switch(next(a)){
                case LexToInt.plus: read(a); At(a,b); BuildTree("+",2,b); break;
                case LexToInt.minus: read(a); At(a,b); BuildTree("-",2,b); break;
            }
        }
    }
    ...
    public static void At(ArrayList<Token> a, Stack<NSTree> b){
        ...
        while(next(a) == LexToInt.times || next(a) == LexToInt.divide){
            switch(next(a)){
                case LexToInt.times: read(a); Af(a,b); BuildTree("*",2,b); break;
                case LexToInt.divide: read(a); Af(a,b); BuildTree("/",2,b); break;
            }
        }
    }
